...
vim.keymap.set('n', '<leader>cp', '<cmd>let @*=expand("%:p")<CR>', { desc = 'Copy current file path to clipboard' })
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>c', '<cmd>TSContextToggle<CR>', { noremap = true, silent = true })
    end,
  },
